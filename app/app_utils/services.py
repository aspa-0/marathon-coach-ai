...
def get_memory_service():
    """Process-wide memory service: Vertex AI Memory Bank when agent_engine_id is set."""
    if agent_engine_id := (os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_ID") or os.environ.get("MEMORY_BANK_ID")):
